          ...
          <div className="product-details-content">
            <div className="product-main-content">
              ...
              <p className="product-details-created-by">
                Created by: <span className="product-details-creator-name">{product.creatorName}</span>
              </p>

              {/* Creator Profile */}
              <div className="product-details-creator-info">
                <img
                  src={product.creatorProfilePic || '../'}
                  alt="Creator Profile"
                  className="product-details-creator-pic"
                />
                <span className="product-details-creator-name-text">{product.creatorName}</span>
              </div>

              {/* Starting Bid */}
              <h3 className="product-details-starting-bid-title">Starting Bid <p className="product-details-starting-bid">{product.startingBid} USD</p></h3>
              ...
              <div className="product-details-tags-container">
                {product.tags?.map((tag, index) => (
                  <button key={index} className="product-details-tag-button">{tag}</button>
                ))}
              </div>
            </div>
  ...
  <div className="bid-input-box">
    ...
    <button className="place-bid-button">Place Bid</button>
          ...
          <div className="explore-more-container">
            <h2 className="product-details-explore-title">Explore More Artwork  <button className="product-details-view-more-button">→ View More</button></h2>
